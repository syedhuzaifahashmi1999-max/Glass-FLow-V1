...
const AddInvoiceModal: React.FC<AddInvoiceModalProps> = ({ isOpen, onClose, onSave, customers, products }) => {
    ...
    <div className={`fixed inset-0 z-[100] flex items-center justify-center p-4 transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
       ...
       `}>
         ...
         <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/50 shrink-0">
           <div>
             <h2 className="text-lg font-light text-black tracking-tight">Create New Invoice</h2>
           </div>
         ...
         <div className="overflow-y-auto custom-scrollbar flex-1">
           <form onSubmit={handleSubmit} className="p-6 space-y-6">
             ...
             <div className="pt-2 flex justify-end gap-3 border-t border-gray-100">
               ...
               <button type="submit" className="px-6 py-2 rounded-lg bg-black text-white hover:bg-gray-800 transition-all text-xs font-medium shadow-lg shadow-black/5">Create Invoice</button>
             </div>
